                        ...
                        <div class="linux-section">
                            <div class="container">
                                <div class="linux-grids">
                                    ...
                                    <h2><?php echo $output2[0]['prod_name'];?></h2>
                                    <?php echo $output2[0]['html'];?>
                                    ...
                                    ?>
                                                <div class="col-md-3 linux-price">
                                                    ...
                                                    <div class="linux-bottom">
                                                        ...
                                                        <li><strong>Mail Box</strong> <?php echo $mail ?></li>
                                                        <li><strong>Language </strong>  <?php echo $lang ?></li>
                                                        <li><strong>Band Width</strong>  <?php echo $band ?></li>
